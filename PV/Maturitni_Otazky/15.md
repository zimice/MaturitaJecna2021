...
#### Hierarchie rozdělení objekt

![](images/JavaMetalevelHierarchy.png)

    java.lang.Object je odděděn od třídy java.lang.Class a třída Dog je odděděna od třídy Object.Každý datový typ má je odděděn od nějaké třídy, která je odděděna od Objectu.Například Integer je odděden od třídy Number a ta je od Objectu.
